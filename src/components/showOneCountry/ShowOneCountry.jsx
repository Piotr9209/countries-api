                ...
                {statusCountry === 'success' && country.map(country => (
                    <div key={country.name.common}>
                        ...
                        <div className='oneCountryInfo'>
                            ...
                            <div className='oneCountryInfoLvlDomain'>
                                ...
                                <p><span>Languages: </span>
                                    {Object.values(country?.languages)[0] && <span>{Object.values(country?.languages)[0]}</span>}
                                    {Object.values(country?.languages)[1] && <span>, {Object.values(country?.languages)[1]}</span>}
                                    {Object.values(country?.languages)[2] && <span>, {Object.values(country?.languages)[2]}</span>}
                                </p>
                            </div>
